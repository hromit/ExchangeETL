...
object TestJSOUPNewsDetail extends App{
  ...
  val file: File  = new File("C:\\Users\\91801\\Downloads\\chromedriver_win32\\MoneyControlNewsPoliticsDetailPage.html")



  val loadFile = Jsoup.parse(file,null)

  val elements: Elements =  loadFile.select("p")
